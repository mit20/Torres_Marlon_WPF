...
var bitrateGlobal = prompt("What bit rates are your songs? (Enter 128 or 256)");//declared and defined variable bitrate. Prompt asks user question.
...
function calcSongs(songs, averageSongLength, bitrate){
    ...
    if(bitrate == 128){
        return "If you upload " + songs + " it will take up " + (songs * averageSongLength) * mbOne + " megabytes.";
    }else if(bitrate == 256){
        return "If you upload " + songs + " it will take up " + (songs * averageSongLength) * mbTwo + " megabytes.";
    }else{
